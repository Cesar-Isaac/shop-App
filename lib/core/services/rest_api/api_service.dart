...
class APIService extends GetxService {
  ...
  APIService({
    ...
    if (withLog) log("API Headers: $_headers");
  }
  ...
  Future<ResponseModel> request<T>(Request<T> request) async {
    ...
    if (withLog) log("Request Header: $requestHeader");
    ...
    try {
      ...
      responseModel =
          ResponseModel(success: false, data: null, message: e.toString());
    }

    log("Response: ${responseModel.data}");
    return responseModel;
  }
}
